...
def processImage(path, name):
	...
	print(size)
	splitAndSave(img, size, 0, size, addToFilename(name, "_py"))
	splitAndSave(img, 0, size, size, addToFilename(name, "_nx"))
	splitAndSave(img, size, size, size, addToFilename(name, "_pz"))
	splitAndSave(img, 2*size, size, size, addToFilename(name, "_px"))
	splitAndSave(img, 3*size, size, size, addToFilename(name, "_nz"))
	splitAndSave(img, size, 2*size, size, addToFilename(name, "_ny"))
